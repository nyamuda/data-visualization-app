        ...
        >
            ...
            <div class="mb-4 px-4">
                ...
                <div
                    ...
                    @click="viewSection"
                    class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer bg-gray-100 transition duration-500 ease-in-out"
                >
                    <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
                        <path
                ...
                >
                    ...
                    <span class="text-gray-700">Register New User</span>
                </div>
                <div
                ...
                >
                    ...
                    <span class="text-gray-700">Add New Questions</span>
                </div>
                <div
                    class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer bg-gray-100 transition duration-1000 ease-in-out"
                >
                    <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
                        <path
            ...
            <div class="mb-4 px-4">
                <p class="pl-4 text-sm font-semibold mb-1">All Questions</p>
                <div
                    class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer bg-gray-100 transition duration-1000 ease-in-out"
                >
                    <svg class="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
                    ...
                    <span class="text-gray-700">Ad</span>
                </div>
                <div
                    class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer bg-gray-100 transition duration-1000 ease-in-out"
                >
            ...
            <div class="mb-4 px-4">
                <p class="pl-4 text-sm font-semibold mb-1"></p>
                <div
