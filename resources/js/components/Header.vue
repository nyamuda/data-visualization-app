        ...
        >
            ...
            <div class="hidden flex-grow lg:flex items-center w-auto -mt-4">
                <div class="text-sm flex-grow">
                    <router-link
                        to="/survey_list"
                        class="mt-4 inline-block lg:mt-0 text-gray-300 hover:no-underline hover:text-white mr-4"
                    >
                        Survey List
                    </router-link>
                    <a
                    ...
                    <a
                        href="#responsive-header"
                        class="mt-4 inline-block lg:mt-0 text-gray-300 hover:no-underline hover:text-white"
                    >
                        Blog
                    </a>
                </div>
